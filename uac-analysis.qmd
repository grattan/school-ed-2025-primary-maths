...
# Define the set groups, as filtering condition for the following function. i.e. list which subgroup to explore. This is a named character vector. Names are subsequenty used.

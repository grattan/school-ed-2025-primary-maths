...
# Save all of these using grattan_save_all.  

user_atlas_folder <- "C:/Users/PETRIE/The University of Melbourne/2024 Primary schools maths - General/3. Data/4. Uni entry data/atlas/"

grattan_save_pptx(band_proportion_charts, glue(user_atlas_folder, "band_proportion_charts.pptx"))

###Some warnings. Check these.
###Charts not producing the desired output. Some issues wiht missing data, and representation of bands. Fix this up.
```
...
all_students_band_numbers <- tribble(
  ~year, ~subject, ~number, ~median, ~Level6, ~Level5, ~Level4, ~Level3, ~Level2, ~Level1, ~source,
  ...
  2017, "Mathematics General 2", 31543, 70, 7, 19, 25, 24, 17, 8, "https://www.uac.edu.au/assets/documents/scaling-reports/Scaling-Report-2017-NSW-HSC.pdf",
  2017, "Mathematics", 17060, 81, 24, 30, 22, 16, 6, 2, "https://www.uac.edu.au/assets/documents/scaling-reports/Scaling-Report-2017-NSW-HSC.pdf",
  2017, "Mathematics Extension 1", 8770, 42, NA, NA, 38, 44, 16, 2, "https://www.uac.edu.au/assets/documents/scaling-reports/Scaling-Report-2017-NSW-HSC.pdf",
  2017, "Mathematics Extension 2", 3223, 84, NA, NA, 34, 51, 13, 2, "https://www.uac.edu.au/assets/documents/scaling-reports/Scaling-Report-2017-NSW-HSC.pdf",
  2016, "Mathematics General 2", 31758, 70, 5, 21, 26, 24, 16, 8, "https://www.uac.edu.au/assets/documents/scaling-reports/Scaling-Report-2016-NSW-HSC.pdf",
  2016, "Mathematics", 16139, 81, 23, 29, 24, 16, 4, 4, "https://www.uac.edu.au/assets/documents/scaling-reports/Scaling-Report-2016-NSW-HSC.pdf",
  2016, "Mathematics Extension 1", 8671, 42, NA, NA, 33, 46, 18, 3, "https://www.uac.edu.au/assets/documents/scaling-reports/Scaling-Report-2016-NSW-HSC.pdf",
  2016, "Mathematics Extension 2", 3251, 84, NA, NA, 32, 53, 13, 2, "https://www.uac.edu.au/assets/documents/scaling-reports/Scaling-Report-2016-NSW-HSC.pdf",
  2015, "Mathematics", 16450, 80, 20, 33, 28, 10, 6, 3, "https://www.uac.edu.au/assets/documents/scaling-reports/Scaling-Report-2015-NSW-HSC.pdf",
  2015, "Mathematics General 2", 31511, 70, 6, 20, 25, 24, 18, 7, "https://www.uac.edu.au/assets/documents/scaling-reports/Scaling-Report-2015-NSW-HSC.pdf",
  2015, "Mathematics Extension 1", 8954, 42, NA, NA, 34, 50, 14, 2, "https://www.uac.edu.au/assets/documents/scaling-reports/Scaling-Report-2015-NSW-HSC.pdf",
  2015, "Mathematics Extension 2", 3333, 86, NA, NA, 36, 50, 12, 2, "https://www.uac.edu.au/assets/documents/scaling-reports/Scaling-Report-2015-NSW-HSC.pdf",
  2014, "Mathematics General 2", 31321, 70, 6, 20, 26, 25, 18, 5, "https://www.uac.edu.au/assets/documents/scaling-reports/Scaling-Report-2014-NSW-HSC.pdf",
  2014, "Mathematics", 16693, 81, 22, 32, 28, 10, 5, 3, "https://www.uac.edu.au/assets/documents/scaling-reports/Scaling-Report-2014-NSW-HSC.pdf",
  2014, "Mathematics Extension 1", 9022, 42, NA, NA, 30, 54, 13, 3, "https://www.uac.edu.au/assets/documents/scaling-reports/Scaling-Report-2014-NSW-HSC.pdf",
  2014, "Mathematics Extension 2", 3371, 84, NA, NA, 32, 55, 12, 1, "https://www.uac.edu.au/assets/documents/scaling-reports/Scaling-Report-2014-NSW-HSC.pdf"
)

# Test the accuracy of the Level 1 scores by calculating them from the Level 2-6 scores, removing NA's first.

all_students_band_numbers <- all_students_band_numbers |> 
  mutate(Level1_test = if_else(Level1 == (100 - rowSums(select(all_students_band_numbers, Level2:Level6), na.rm = TRUE)),T,F))

# View(all_students_band_numbers)
# All TRUE


#Rename the subjects according to the following list: "Mathematics" becomes "Mathematics Advanced", and "Mathematics General 2" becomes "Mathematics Standard 2"

unique(all_students_band_numbers$subject)

all_students_band_numbers <- all_students_band_numbers |> 
  mutate(common_subject = recode(subject, "Mathematics" = "Mathematics Advanced", "Mathematics General 2" = "Mathematics Standard 2"))

print(unique(all_students_band_numbers$common_subject))

# For each subject, over years 2014 to 2023 calculate the weighted average  of the band numbers, weighting by the number variable.

all_students_10_year_band_numbers <- all_students_band_numbers |> 
  group_by(common_subject) |> 
  summarise(across(c(number, median, Level6:Level1), ~weighted.mean(., w = number, na.rm = TRUE)))

print(all_students_10_year_band_numbers)

# Output the data to an Excel file

output_file2 <- glue(user_data_folder, "UAC_band_performance_data_all_students.xlsx")

# Write to Excel file - this time with a different name for the worksheet

write_xlsx(x = list(all_std_10y_band_num = all_students_10_year_band_numbers), path = output_file2)

...
```{r}
# Creating mean dataframe and confidence intervals for the general public in the dataset
#2000
...
```{r}
# creating plot for year 10 math relative to general population
...
```
```{r}
# Creating plot for literacy scores for year 10s relative to general population

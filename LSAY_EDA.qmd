...
profession_visualisation <- professionals_vis %>%
  ggplot(aes(y = Profession, 
             xdist = dist_normal(Mean_Math, Std_Math))) +
  stat_interval(.width = 0.9) +
  geom_point(aes(x = Mean_Math), size = 3, 
             stroke = 1.5, 
             fill = "white", 
             shape = 21) +
  labs(
    ...
    subtitle = glue("Distribution of PISA 2003 Mathematical Proficiency scores for teachers and other professionals"),
    x = "Score",
    y = "Teacher",
  ...
  annotate(geom = "text", y = 1.5, x = 475, colour = "black", vjust = 0.5, hjust = -.15, label = "Proficiency benchmark", size = 18/.pt) + 
  xlim(300, 800) +

...
pisa_2003 <- haven::read_sav("data/CY02_AUS_PISA2003_StdQ_AchieveandSchQ_forPublic_Release.sav")
...
ggplot(data = data.frame(x = c(-0, 1000)), 
  ...
  stat_function(fun = dnorm, 
                n = 144, args = list(mean = 554, sd = 64.8)) +
  stat_function(fun = dnorm, 
                n = 10226, args = list(mean = 530.3, sd = 92.9), 
                color = grattan_red) +
